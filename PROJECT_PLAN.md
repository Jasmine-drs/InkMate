...
**最后更新**: 2026-03-07 12:27 +0800
**当前状态**: 核心功能已上线，设计审计收口中
...
- [x] 上下文智能检索
- [x] 设定一致性检查
- [ ] 编辑器高级AI操作（缩写/润色/询问/选区一致性检查）
- [ ] AI对话上下文与历史联动
- [ ] 章节批注系统

#### 第六阶段：优化与完善（2周）
- [x] 性能优化
- [x] 导出功能（TXT/EPUB/DOCX）
- [ ] 批量导出与导出历史工作台
- [ ] 数据导入能力
- [x] 用户体验优化
- [ ] 恢复 ESLint 并补冒烟测试

### 7.1.1 2026-03-07 设计审计收口事项
...
说明：多模型/本地模型支持保留为远期扩展，不纳入本轮审计收口。

### 7.2 技术风险与应对

| 风险 | 影响 | 应对策略 |
|------|------|---------|
| LLM API不稳定 | 生成失败率高 | 重试机制、错误恢复、可配置模型接入 |
